...
public class Jsons extends Bases {
    ...
    /**
     * Converts first JSON level to a LinkedHashMap with String keys and values of type LinkedHashMap, ArrayList, String, or Basic types wrapped
     * @param json_tex
     * @param ok
     * @param extras_array
     * @return
